...
//     @Query("SELECT new com.loanlelo.LoanLeLe.DTO.ConsumerDTO.ConsumeProfileLoanData(l.loanAmount, l.status, l.loanPurpose, l.interestRate, l.loanTerm)"
//             + "FROM Consumer c " + "JOIN c.loanTakenByConsumer l" + " WHERE c.email = :email")
